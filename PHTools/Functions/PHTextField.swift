...
public class PHTextField : UITextField {
...
extension PHTextField{
    public convenience init(placeHolder:String, textColor:UIColor? = UIColor.black, font:UIFont? = UIFont.systemFont(ofSize: 12),textAlignment:NSTextAlignment? = .left, leftView:UIView? = nil, rightView:UIView? = nil)
    {
