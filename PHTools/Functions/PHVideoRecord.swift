...
import UIKit
import AVFoundation
public class PHCaptureManager: NSObject,AVCaptureFileOutputRecordingDelegate {
    
    
    public func startRecord(captureSession:AVCaptureSession,fileOut:AVCaptureMovieFileOutput) {
...
public class PHCaptureObject: NSObject {
    ...
    //  将捕获到的视频输出到文件
    public let fileOut = AVCaptureMovieFileOutput()
